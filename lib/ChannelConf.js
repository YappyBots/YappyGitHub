...
class ChannelConf {
  ...
  */
  ...
  /**
  * @see {@link Collection#find}
  */
  find() {
    return this._channelconf.find(...arguments);
  }

  /**
  * @see {@link Collection#array}
  */
  array() {
    return this._channelconf.array(...arguments);
  }

  /**
  * @see {@link Collection#exists}
  */
  exists() {
    return this._channelconf.exists(...arguments);
  }

  /**
  * @see {@link Collection#filter}
  */
  filter() {
    return this._channelconf.filter(...arguments);
  }
