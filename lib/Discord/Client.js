...
class Client extends DiscordClient {
  ...
  */
  runCommand(msg) {
    ...
    const content = (msg.content.startsWith(prefix) && msg.content.replace(prefix, '')) || (msg.mentions.has(this.bot.user) && msg.content.split('>').slice(1).join('>')) || (msg.content.startsWith(this.prefix) && msg.content.replace(this.prefix, '')) || msg.content;
