...
const app = express();
const port = process.env.YAPPY_GITHUB_BETA_PORT || process.env.OPENSHIFT_NODEJS_PORT || process.env.PORT || 8080;
const ip = process.env.YAPPY_GITHUB_BETA_IP || process.env.OPENSHIFT_NODEJS_IP || process.env.IP || null;
...
app.use(addons.express.middleware(bot, require('./Models'), {
  CLIENT_ID: process.env.YAPPY_GITHUB_BETA_DISCORD_CLIENT_ID,
  CLIENT_SECRET: process.env.YAPPY_GITHUB_BETA_DISCORD_CLIENT_SECRET,
